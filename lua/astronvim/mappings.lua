...
if is_available "telescope.nvim" then
  ...
  maps.n["<leader>fb"] =
    { function() require("telescope.builtin").buffers { initial_mode = "normal" } end, desc = "Find buffers" }
  maps.n["<leader>fc"] = {
    function() require("telescope.builtin").grep_string { initial_mode = "normal" } end,
...
maps.n["[<Space>"] = { "<cmd>put! =repeat(nr2char(10), v:count1)|silent ']+<cr>", desc = "Insert blank line above" }
maps.n["]<Space>"] = { "<cmd>put =repeat(nr2char(10), v:count1)|silent ']-<cr>", desc = "Insert blank line below" }
maps.n["<C-u>"] = { "<C-u>zz" }
maps.n["<C-d>"] = { "<C-d>zz" }
maps.n["n"] = { "nzz" }
maps.n["N"] = { "Nzz" }
