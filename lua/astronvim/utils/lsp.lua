...
M.on_attach = function(client, bufnr)
  ...
  if is_available "telescope.nvim" then -- setup telescope mappings if available
    ...
    if lsp_mappings.n.gI then
      lsp_mappings.n.gI[1] = function() require("telescope.builtin").lsp_implementations { initial_mode = "normal" } end
    end
    if lsp_mappings.n.gr then
      lsp_mappings.n.gr[1] = function() require("telescope.builtin").lsp_references { initial_mode = "normal" } end
    end
